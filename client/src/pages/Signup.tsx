    ...
    <div className="min-h-screen relative overflow-hidden bg-background">
      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-5xl flex items-center justify-center gap-8">
          <div className="w-full max-w-sm bg-card/95 backdrop-blur-sm border border-card-border rounded-2xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold text-foreground mb-2" data-testid="heading-signup">
            ...
            <div className="space-y-3">
              <Button
                variant="outline"
                className="w-full justify-center gap-3 h-12 bg-background hover:bg-muted"
